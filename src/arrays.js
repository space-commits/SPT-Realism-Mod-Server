...
class Arrays {
    constructor(tables) {
        ...
        this.mod_slot_names = {
            ...
            "bipod": ["mod_bipod"],
            "charge": ["mod_charge"],
            "equipment": ["mod_equipment"],
            "flashlight": ["mod_flashlight"],
            "foregrip": ["mod_foregrip"],
            "gasblock": ["mod_gas_block"],
            "handguard": ["mod_handguard"],
            "launcher": ["mod_launcher"],
            "magazine": ["mod_magazine"],
            "mount": ["mod_mount"],
            "mount00": ["mod_mount_000"],
            "mount01": ["mod_mount_001"],
            "mount02": ["mod_mount_002"],
            "mount03": ["mod_mount_003"],
            "mount04": ["mod_mount_004"],
            "mount05": ["mod_mount_005"],
            "mount06": ["mod_mount_006"],
            "muzzle": ["mod_muzzle"],
            "nvg": ["mod_nvg"],
            "pistolgrip": ["mod_pistol_grip"],
            "pistolgrip-AKMS": ["mod_pistol_grip_akms"],
            "reciever": ["mod_reciever"],
            "scope": ["mod_scope"],
            "scope00": ["mod_scope_000"],
            "scope01": ["mod_scope_001"],
            "scope02": ["mod_scope_002"],
            "scope03": ["mod_scope_003"],
            "frontsight": ["mod_sight_front"],
            "rearsight": ["mod_sight_rear"],
            "stock": ["mod_stock"],
            "altstock": ["mod_stock_000"],
            "altstock1": ["mod_stock_001"],
            "stockaxis": ["mod_stock_axis"],
            "tactical": ["mod_tactical"],
            "tactical00": ["mod_tactical_000"],
            "tactical01": ["mod_tactical_001"],
            "tactical02": ["mod_tactical_002"],
            "tactical03": ["mod_tactical_003"],
            "tactical04": ["mod_tactical_004"]
        };
        this.neutral_include = [
