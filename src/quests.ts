...
export class Quests {
    ...
    public questDB = this.tables.templates.quests;
    public questLoaleObj = this.tables.locales.global["en"].quest;
    public questDesc = this.tables.locales.global["en"].mail;
