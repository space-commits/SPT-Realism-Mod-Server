    ...
    loadHazardQuests() {
        ...
        for (let i in this.tables.locales.global) {
            ...
            locale["6681c5127b9973f80c7c7d12 description"] = "Greetings, mercenary. I have some easy work for you. Even before the Contract Wars we've had patients coming in with respiratory distress and other strange symptoms. Fatigue, tunnel vision, and even in some cases rapid organ failure..." +
                ...
                + "\n\nThere used to be a chemical plant in the factory and warehouse complex next to the Customs road, near the UN checkpoint. It was owned by TerraGroup corporation or one of its subsidiaries, I'm sure you're familiar with them. This could be one of the sources of the contamination. Their trademark is featured all over, you can't miss it. I need you to locate some of the infrastructure used to manufacture and store chemical products. I will send in my people to take samples once you've done so.";
