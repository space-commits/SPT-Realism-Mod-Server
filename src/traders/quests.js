    ...
    loadHazardQuests() {
        ...
        for (let i in this.tables.locales.global) {
            ...
            locale["6702afe9504c9aca4ed75d9a description"] = "We have a situation on our hands here. We've had an influx of new patients, more than usual, all describing respiratory distrees."
                + " They all claim that their symptoms started when a thick fog descended on their village...superstitious  villager talk between you and me, an old man was ranting about dark figures lurking in the fog."
            ...
            locale["6702b0a1b9fb4619debd0697 description"] = "More and more patients are coming in, all with the same symptoms as before. It doesn't matter how much supplies you bring us, this is not sustainable."
                ...
                + "\n\nThe blood tests came back inconclusive as a match for the samples we've collected previously. We need to figure out the origin of this contamination. I am giving you a GAMU device to collect readings in the field. You need to test in areas where large quantities of toxic materials have been stored or manufactured."
                + " There's no point getting multiple readings from the same location, try different areas. Also it must be placed in areas of sufficient contamination, prioritize sources of contamination rather than just where it has accumulated."
            ...
            locale["6702b8b3c0f2f525d988e428 successMessageText"] = "My suspicions have been confirmed...they are behind this, unless someone else is putting them up to it...What I saw on these cameras will scar me for the rest of my life. These are sick, sick men. They weren't always like this, they were made this way. This act of terrorism may just be the beginning. They keep muttering incantations about a 'blue flame'...I'm sure more will be revealed in time.";
            ...
            locale["670ae811bd43cbf026768126 description"] = "Close the door behind you. My people have trawled through the footage we've collected so far. They communicate in coded language, in some sort of cipher. We have made preliminary attempts at decoding it. From what we've gathered, they were the ones targeting the rail networks leading out of Tarkov."
                ...
                + " I need you to place a RAMU device at these sites to collect data. These devices work much the same as the GAMU devices you used before. Make sure to place them in the center of the loading sites otherwise they may fail to take a reading. I'm sure you remember these sites are likely to be highly radioactive, practice caution. Also do everything you can to avoid contact, we can't afford for them to know we're tracking their movements.";
            ...
            locale["6702b3e4aff397fa3e666fa5 description"] = "These people, these...cultists...some of them were former patients of mine. What was done to them is not my fault, you understand? They volunteered for TerraGroup medical studies. It was my job to monitor and assess them, treat them when I was allowed..."
            ...
            locale["6702b4a27d4a4a89fce96fbc description"] = "It all comes down to this. If we fail, we all die. There is no way to evacuate the civilians that remain in Tarkov, Cultists are stalking the routes out of the region, and exchanging fire with UN and RUAF forces."
                ...
                + " If we can find and use a powerful satellite dish to establish a comm link, my people can repurpose and hijack the satelite to establish contact outside of the Tarkov region. The next time the satellite will be overhead is October 31st and will only be available for a few days after that. Nights are forecast to have the best signal, less interfering traffic."
                + "\n\nThe Shoreline area has a number of satellite dishes. The dish needs to be facing north and have a clear line of sight and good elevation. I will give you a device for establishing the comm link and transmitting the authorization codes. Do. Not. Lose. The. Device. Mechanic only had enough components to build two of them. I hope I do not need to remind you that if you are to fail, it's over for all of us.";
            ...
            locale["6681c5127b9973f80c7c7d12 description"] = "Greetings, mercenary. I have some easy work for you. Even before the Contract Wars we've had patients coming in with respiratory distress and other strange symptoms. Fatigue, tunnel vision, and even in some cases rapid organ failure..." +
                ...
                + "\n\nHowever, we've had a recent influx of patients showing those same symptoms from all that time ago; I need you to find the source of this contamination. We're unsure if this is connected to the water contamination you helped us remediate before."
            ...
            locale["66dad1a18cbba6e558486336 description"] = "I need you to listen to everything I am about to tell you very, very carefully. This is not the time to ignore what I have to say. If you don't, then whatever happens is on you."
                + "\n\nI can not tell you exactly what we discovered at the derailment, this is too sensitive of a matter. I hope you understand, and that you know you can trust me. What I can tell you is that the train derailment was not an accident, and according to the manifest many materials are missing. There were other trains that did not make it, I don't think I need to elaborate on the implications."
                ...
                + "\n\nAre you listening? Good. These materials are extremely hazardous, radioactive. There is something ...unusual about the substances involved, almost as if the air around it is contaminated. If you are not careful and prepare accordingly, you will likely die a slow agonizing death. As a doctor I am not prone to hyperbole. We lack the resources to treat severe radiation poisoning. If you fall ill, pray that you can somehow conjure up all the supplies needed to treat you.";
            ...
            locale["6705425a0351f9f55b7d8c61 description"] = "Well, well, well...quite the situation you've created, haha! Look at you, you're all fucked up! I'd say you're lucky to have survived that, but I'm thinking you'd rather be dead right about now."
                ...
                + " Makes no odds to me, I'm a survivor, I can thrive in any environment. If anything you did me a favour getting rid of those bottom feeders."
        ...
        for (let q in pmc.Quests) {
            ...
            if (quest.qid === questId) {
                if (quest.status === 4) {
                    ...
                    if (quest.statusTimers["4"])
                        delete quest.statusTimers["4"];
                    if (quest.statusTimers["3"])
                        delete quest.statusTimers["3"];
                }
                break;
            }
        }
