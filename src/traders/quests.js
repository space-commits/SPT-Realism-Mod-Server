...
class Quests {
    ...
    loadHazardQuests() {
        ...
        for (let i in this.tables.locales.global) {
            ...
            locale["6681c5127b9973f80c7c7d12 description"] = "Greetings, mercenary. I have some easy work for you. Even before the Contract Wars we've had patients coming in wtih respiratory distress and other strange symptoms. Fatigue, tunnel vision, and even in some cases death..." +
                ...
                + "\n\n There used to be a chemical plant in the factory and warehouse complex next to the Customs road, near the UN checkpoint. It was owned by TerraGroup corporation or one of its subsidiaries, I'm sure you're familar with them. This could be one of the sources of the contamination. Their trademark is plastered all over, you can't miss it. I need you to locate some of the infrastructure used to manufacture and distribute these materials. I will send in my people to take samples once you've done so.";
        ...
        for (let i in this.tables.locales.global) {
            ...
            locale["6681d150fd1d7f0b7e5ae953 description"] = "My people found more than just a chemical manufacturing plant. Manifests found on site indicated that there was more outboard cargo, headed outside the Tarkov region. From out contacts outside, it seems that the train did not make it to its destination."
                + " We don't know which route they would have taken, the Customs area is criss crossed by many rail lines. What we do know is that included in the cargo was not only toxic substances, but also radioactive materials. I don't dare to speculate what was there intended purpose."
