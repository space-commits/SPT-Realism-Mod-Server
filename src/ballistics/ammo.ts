    ...
    public loadAmmoStats() {
        ...
        for (let i in this.itemDB()) {
            ...
            if (serverItem._id === "64b8ee384b75259c590fa89b") {
                ...
                serverItem._props.ProjectileCount = 8; //26
                serverItem._props.Damage = 130 / serverItem._props.ProjectileCount;
            ...
            if (serverItem._id === "5d6e6911a4b9361bd5780d52") {
                ...
                serverItem._props.ProjectileCount = 8; //18
                serverItem._props.Damage = 126 / serverItem._props.ProjectileCount;
            ...
            if (serverItem._id === "5d6e6772a4b936088465b17c") {
                serverItem._props.PenetrationPower = 8;
                serverItem._props.ArmorDamage = 1;
                serverItem._props.ProjectileCount = 8; //24
                serverItem._props.Damage = 168 / serverItem._props.ProjectileCount;
            ...
            if (serverItem._id === "5d6e6806a4b936088465b17e") {
                ...
                serverItem._props.ArmorDamage = 1;
                serverItem._props.ProjectileCount = 8; //9
                serverItem._props.Damage = 234 / serverItem._props.ProjectileCount;
            ...
            if (serverItem._id === "5d6e67fba4b9361bc73bc779") {
                ...
                serverItem._props.ArmorDamage = 1;
                serverItem._props.ProjectileCount = 8; //15
                serverItem._props.Damage = 210 / serverItem._props.ProjectileCount;
            ...
            if (serverItem._id === "5c0d591486f7744c505b416f") {
                ...
                serverItem._props.HeavyBleedingDelta = 0.95;
                serverItem._props.LightBleedingDelta = 1;
            ...
            if (serverItem._id === "5d6e68b3a4b9361bca7e50b5") {
                ...
                serverItem._props.LightBleedingDelta = 0.8;
                serverItem._props.ammoAccr = 0;
                serverItem._props.ammoHear = 0;
                serverItem._props.ammoRec = 24;
            ...
            //// 20ga ////
            //Flechette shot
            if (serverItem._id === "6601380580e77cfd080e3418") {
                serverItem._props.PenetrationPower = 5;
                serverItem._props.ArmorDamage = 0.5;
                serverItem._props.ProjectileCount = 6; //14
                serverItem._props.Damage = 120 / serverItem._props.ProjectileCount;
                serverItem._props.InitialSpeed = 300;
                serverItem._props.RicochetChance = 0.9;
                serverItem._props.FragmentationChance = 0.12;
                serverItem._props.BulletMassGram = 0.47;
                serverItem._props.HeavyBleedingDelta = 0.6;
                serverItem._props.LightBleedingDelta = 0.8;
                serverItem._props.ammoAccr = -130;
                serverItem._props.ammoHear = 0;
            ...
            if (serverItem._id === "5d6e695fa4b936359b35d852") {
                serverItem._props.PenetrationPower = 8;
                serverItem._props.ArmorDamage = 1;
                serverItem._props.ProjectileCount = 15; //15
                serverItem._props.Damage = 135 / serverItem._props.ProjectileCount;
            ...
            if (serverItem._id === "5d6e69b9a4b9361bc8618958") {
                ...
                serverItem._props.ArmorDamage = 1;
                serverItem._props.ProjectileCount = 8; //12
                serverItem._props.Damage = 144 / serverItem._props.ProjectileCount;
                serverItem._props.InitialSpeed = 410;
            ...
            if (serverItem._id === "5d6e69c7a4b9360b6c0d54e4") {
                ...
                serverItem._props.ArmorDamage = 1;
                serverItem._props.ProjectileCount = 10; //10
                serverItem._props.Damage = 160 / serverItem._props.ProjectileCount;
            ...
            if (serverItem._id === "5a38ebd9c4a282000d722a5b") {
                ...
                serverItem._props.ArmorDamage = 1;
                serverItem._props.ProjectileCount = 8; //9
                serverItem._props.Damage = 171 / serverItem._props.ProjectileCount;
                serverItem._props.InitialSpeed = 430;
                serverItem._props.RicochetChance = 0.24;
            ...
            //Dangerous game
            if (serverItem._id === "660137ef76c1b56143052be8") {
                serverItem._props.PenetrationPower = 45;
                serverItem._props.ArmorDamage = 1;
                serverItem._props.Damage = 130;
                serverItem._props.InitialSpeed = 476;
                serverItem._props.RicochetChance = 0.25;
                serverItem._props.FragmentationChance = 0.25;
                serverItem._props.BulletMassGram = 19.4;
            ...
            //AP slug
            if (serverItem._id === "660137d8481cc6907a0c5cda") {
                serverItem._props.PenetrationPower = 57;
                serverItem._props.ArmorDamage = 1;
                serverItem._props.Damage = 120;
                serverItem._props.InitialSpeed = 482;
                ...
                if (this.modConf.malf_changes == true) {
                    ...
                    serverItem._props.MisfireChance = 0;
                    serverItem._props.MalfFeedChance = 0;
                    serverItem._props.DurabilityBurnModificator = 2.21;
                    serverItem._props.HeatFactor = 1.5;
                }
            }
            //// KS23 ////
            ...
            if (serverItem._id === "5f647f31b6238e5dd066e196") {
                ...
                serverItem._props.ArmorDamage = 1;
                serverItem._props.ProjectileCount = 8;
                serverItem._props.Damage = 240 / serverItem._props.ProjectileCount;
            ...
            //FMJ
            if (serverItem._id === "668fe62ac62660a5d8071446") {
                serverItem._props.PenetrationPower = 40;
                serverItem._props.ArmorDamage = 1.1;
                serverItem._props.Damage = 120;
                serverItem._props.RicochetChance = 0.1;
            ...
            if (serverItem._id === "5736026a245977644601dc61") {
                serverItem._props.PenetrationPower = 36;
                serverItem._props.ArmorDamage = 1;
                serverItem._props.Damage = 52;
                serverItem._props.InitialSpeed = 430;
                serverItem._props.RicochetChance = 0.4;
            ...
            // M80A1
            if (serverItem._id === "6768c25aa7b238f14a08d3f6") {
                serverItem._props.PenetrationPower = 84;
                serverItem._props.ArmorDamage = 1;
                serverItem._props.Damage = 130;
                serverItem._props.InitialSpeed = 914;
                serverItem._props.RicochetChance = 0.35;
                serverItem._props.FragmentationChance = 0;
                serverItem._props.BulletMassGram = 8.42;
                serverItem._props.HeavyBleedingDelta = 0.3;
                serverItem._props.LightBleedingDelta = 0.85;
                serverItem._props.ammoAccr = -5;
                serverItem._props.ammoHear = 0;
            ...
            if (serverItem._id === "64b7af434b75259c590fa893") {
                ...
                serverItem._props.ArmorDamage = 0.95;
            ...
            if (serverItem._id === "601aa3d2b2bcb34913271e6d") {
                serverItem._props.PenetrationPower = 80;
                serverItem._props.ArmorDamage = 0.8;
                serverItem._props.Damage = 70;
                serverItem._props.InitialSpeed = 875;
                serverItem._props.RicochetChance = 0.6;
                serverItem._props.FragmentationChance = 0;
                serverItem._props.BulletMassGram = 7.2;
                serverItem._props.HeavyBleedingDelta = 0.29;
                serverItem._props.LightBleedingDelta = 0.63;
            ...
            ///.50 BMG ///
            //HP
            if (serverItem._id === "686e90abd63bee9a05dcf5db") {
                serverItem._props.PenetrationPower = 75;
                serverItem._props.ArmorDamage = 10;
                serverItem._props.Damage = 450;
                serverItem._props.InitialSpeed = 823;
                serverItem._props.RicochetChance = 0.05;
                serverItem._props.FragmentationChance = 0.05;
                serverItem._props.BulletMassGram = 50;
                serverItem._props.HeavyBleedingDelta = 1;
                serverItem._props.LightBleedingDelta = 1;
                serverItem._props.ammoAccr = -35;
                serverItem._props.ammoHear = 0;
                serverItem._props.ammoRec = 3.5;
            ...
            //M21 (API)
            if (serverItem._id === "686e926498b323bfbbe1fc7c") {
                serverItem._props.PenetrationPower = 120;
                serverItem._props.ArmorDamage = 5;
                serverItem._props.Damage = 300;
                serverItem._props.InitialSpeed = 884;
                serverItem._props.RicochetChance = 0.25;
                serverItem._props.FragmentationChance = 0.0;
                serverItem._props.BulletMassGram = 45.3;
                serverItem._props.HeavyBleedingDelta = 1;
                serverItem._props.LightBleedingDelta = 1;
                serverItem._props.ammoAccr = -15;
                serverItem._props.ammoHear = 0;
            ...
            //M33 (FMJ)
            if (serverItem._id === "686e93d861bcbeca0b805201") {
                serverItem._props.PenetrationPower = 85;
                serverItem._props.ArmorDamage = 7;
                serverItem._props.Damage = 350;
                serverItem._props.InitialSpeed = 853;
                serverItem._props.RicochetChance = 0.1;
                serverItem._props.FragmentationChance = 0.2;
                serverItem._props.BulletMassGram = 42.8;
                serverItem._props.HeavyBleedingDelta = 1;
                serverItem._props.LightBleedingDelta = 1;
                serverItem._props.ammoAccr = 50;
                serverItem._props.ammoHear = 0;
            ...
            //m903 (SLAAP)
            if (serverItem._id === "686e959752397d5b3485ad75") {
                serverItem._props.PenetrationPower = 140;
                serverItem._props.ArmorDamage = 4;
                serverItem._props.Damage = 250;
                serverItem._props.InitialSpeed = 1219;
                serverItem._props.RicochetChance = 0.5;
                serverItem._props.FragmentationChance = 0.3;
                serverItem._props.BulletMassGram = 23.3;
                serverItem._props.HeavyBleedingDelta = 1;
                serverItem._props.LightBleedingDelta = 1;
                serverItem._props.ammoAccr = -25;
                serverItem._props.ammoHear = 0;
    ...
    public grenadeTweaks() {
        for (let i in this.itemDB()) {
            ...
            if (serverItem._id === "58d3db5386f77426186285a0") {
                ...
                serverItem._props.FragmentsCount = 140;
            }
            //f-1
            if (serverItem._id === "5710c24ad2720bc3458b45a3") {
                ...
                serverItem._props.FragmentsCount = 130;
            }
            //rgd
            if (serverItem._id === "5448be9a4bdc2dfd2f8b456a") {
                ...
                serverItem._props.Weight = 0.31;
                serverItem._props.FragmentsCount = 120;
            }
            //rgo
            if (serverItem._id === "618a431df1eb8e24b8741deb") {
                ...
                serverItem._props.Contusion.y = 12;
                serverItem._props.Contusion.z = 15;
                serverItem._props.FragmentsCount = 110;
            }
            //rgn
            if (serverItem._id === "617fd91e5539a84ec44ce155") {
                ...
                serverItem._props.FragmentsCount = 100;
            }
            //vog-17
            if (serverItem._id === "5e32f56fcb6d5863cc5e5ee4") {
                ...
                serverItem._props.FragmentsCount = 90;
            }
            //vog-25
            if (serverItem._id === "5e340dcdcb6d5863cc5e5efb") {
                ...
                serverItem._props.Contusion.z = 20;
                serverItem._props.FragmentsCount = 95;
            }
            //vog-40mm
